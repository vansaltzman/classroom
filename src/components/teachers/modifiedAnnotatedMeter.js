  ...
  (0, _createClass3.default)(AnnotatedMeter, [{
    ...
    value: function render() {
      ...
      if (index >= 0) {
        ...
        // });
        value = Math.round(series.reduce((sum, each) => {
          return sum += each.value
        }, 0) / series.length)
        label = _react2.default.createElement(_FormattedMessage2.default, { id: 'Total', defaultMessage: 'Average' });
      }
